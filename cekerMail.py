...
#Oy Goblok keluar lu Jangan recode

# Jangan Di Recode Ya Bossku

# Tinggal Make Aja Apa Susahnya Sih :)

#Team : LNX#CREW,S.T.C,I.T.A,BUFT
...
\033[1;32m
 _                  __  __       _ _
  ...
  / _ \ | '_ ` _ \|_  / |\/| |/ _` | | |
 / ___ \| | | | | |/ /| |  | | (_| | | |
/_/   \_\_| |_| |_/___|_|  |_|\__,_|_|_|\033[0m        \t-={ \033[1;36mBy InYourG00D\033[0m }=-
"""

print banner
list = raw_input("\033[33;1m[+]Input Mail List : \033[0m")
...
while True:
	...
	if:
		...
		print("\033[32;1mLIVE\033[0m | "+email+" | [ Amz Email ] | [S0UL T3AM CYB3R]")
...
print("\033[35;1mProses Mengecek selesai By InYourG00D - ./LNX#CREW\033[0m")
